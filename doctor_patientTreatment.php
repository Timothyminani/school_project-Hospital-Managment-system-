            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="action_td">
                        ...
                        <a href="#"> <span class="removedbtn" id="Treatment_bnt">Treatment</span> </a>
                    </td>
                </tr>
...
<div class="userAcount_info">
    ...
    <footer class="footer">
        ...
        <p class="copyright">&copy; 2024 Timothy Minani. All rights reserved.</p>
         ...
         <div class="patient_treatmentBox" id="Patient_treatmentBox1">
            <h3 class="patientTreatment_text">Patient Treatment</h3>
            <i id="close_treatment"   class="fa-solid fa-xmark"></i>

<div class="patient_treatment_text">
 <h4 class="prescription_text">Patient Treatment / Prescription</h4>
</div>

<textarea name="" id="" placeholder="Write Here Patient Treatment Detail" class="text_area">

</textarea>

<div class="Release_btn">
    <input type="submit" name="fname" value="Release"> 
</div>


<div class="Admit_btn">
    <input type="submit" name="fname" id="Admit" value="ADMIT"> 
</div>
         ...
         <div class="inpatientBox" id="inpatientBox">
            ...
            <textarea name="" id="reason_description" placeholder="Describe the current symptoms or issues that led to hospitalization">
            ...
            <textarea name="" id="MedicalHistory_description" placeholder="Describe the Medical History of a patient">
            ...
            <input type="text" id="insurance-provider" name="insurance-provider">
              ...
              <div class="insurence_provider">
                ...
                <input type="text" id="insurance-provider1" name="insurance-provider">
                  </div>
                        ...
                        <select id="ward2" name="ward">
                          ...
                          <div class="insurence_provider">
                            ...
                            <select id="ward3" name="ward">
                              ...
                              <div class="medical_history">
                                <h4 class="reason_forAdmission_msg">Consent</h4>
                            </div>


                            <div class="insurence_provider1">
                                <input type="checkbox" id="treatment-consent" name="treatment-consent" required>
                                <label for="treatment-consent">I give my consent for treatment</label>
                             </div>

                             <div class="insurence_provider1">
                                <input type="checkbox" id="privacy-policy" name="privacy-policy" required>
                                <label for="privacy-policy">I have read and understand the privacy policy</label>
                             ...
                             <div class="submit_box">
                                ...
                                <input type="submit" id="submit_btnSabmit" value="Submit">
                            </div>
