...
echo'<tr>
        ...
        <td>
         <div style="display: flex; justify-content: center;  align-items: center; gap: 2em;">
                 <a href="Doctor_TreatmentInfo_Update.php?treatment_info='.$patient_id.'"> <span class="View_bnt"><i class="fa-regular fa-eye"></i>View</span> </a>
                <a href="doctor_Discharge_Form.php?Discharged='.$patient_id.'"> <span class="btn_remove"  style="  padding: 10px 25px 10px;
    background-color: rgb(225, 78, 78);
    border-radius: 10px;
    color: white;
    font-weight: bold;
    margin-top: 40px;
    margin-left: 20px;     ">Discharge</span> </a>
                </div>
        </td>
    </tr>
